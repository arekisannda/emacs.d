;;; tools-ispell.el --- Emacs Ispell Configurations -*- lexical-binding: t; -*-
;;; Commentary:
...
(defun tools/ispell--load-hunspell-configs ()
  ...
  (setq tools/ispell--check-backend "hunspell"))

(defun tools/ispell--load-aspell-configs ()
  "Load aspell spelling backend."
  (setq ispell-program-name "/usr/bin/aspell")
  ;; Please note ispell-extra-args contains ACTUAL parameters passed to aspell
  (setq ispell-extra-args '("-a" "soundslike" "--sug-mode=ultra" "--lang=en_US"))
  (setq tools/ispell--check-backend "aspell"))
