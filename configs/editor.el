...
;; }}}
(use-package evil-easymotion :after evil :ensure t)
...
(use-package sonokai-theme ;; {{{
  :ensure t
  :elpaca (:repo "arekisannda/sonokai-emacs")
  :config
  (load-theme 'sonokai t))
;; }}}
...
;; }}}
(use-package flycheck-posframe :after flycheck :ensure t)
(use-package flycheck-popup-tip :after flycheck :ensure t)
...
(use-package origami ;; {{{
  :ensure t
  :init
  (setq-default origami-show-fold-header t)
  :config
...
;; }}}
(use-package company-posframe :after company)
